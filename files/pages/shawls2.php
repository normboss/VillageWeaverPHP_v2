        ...
        <div class="shawls-container">
            ...
            <div class="shawls-block">
                <div class="shawls-image">
                    <?php
                    // outputSpinCode("shawl_knotweed1", "jpg", "shawl_knotweed2a", "jpg"); 
                    ?>

                    <div class="card">
                    
                        <div id="shawl_knotweed2a" class="card__side card__side--front">
                            <img src="../images/shawl_knotweed1.jpg" alt="">
                        </div>

                        <div id="shawl_knotweed1" class="card__side card__side--back">
                            <img src="../images/shawl_knotweed2a.jpg" alt="">
                        </div>
                    </div>

                    <script>
                        // document.getElementById( "shawl_knotweed1" ).onclick = function() { fontClick() };
                        // document.getElementById( "shawl_knotweed2a" ).onclick = function() { backClick() };

                        shawl_knotweed1.onclick = function() {
                        ...
                        shawl_knotweed2a.onclick = function() {
                            var front = document.getElementById("shawl_knotweed1");
